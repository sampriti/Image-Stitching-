...
{
	Mat img_1 = imread("img1.png",CV_LOAD_IMAGE_GRAYSCALE);
	Mat img_2 = imread("img2.png",CV_LOAD_IMAGE_GRAYSCALE);
...
// Find homography
	...
	Mat C = (Mat_<double>(3, 3) << 1, 0, 550, 0, 1, 0, 0, 0, 1);//300 for 1st image
